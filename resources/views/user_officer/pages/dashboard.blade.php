...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#">
            <img src="{{ url ('back_office/assets/img/logo-ct.png')}}" class="navbar-brand-img h-100 w-15" alt="...">
...
<main class="main-content mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-1 px-3">
        ...
        <h6 class="font-weight-bolder mb-0">Data Statistik</h6>
        </nav>
        ...
        <ul class="navbar-nav  justify-content-end">
            ...
            <a href="#" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none">Auzan</span>
            </a>
            </li>
            ...
            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                    <div class="my-auto">
                        <img src="{{ url ('back_office/assets/img/small-logos/logo-spotify.svg')}}" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-8">
                <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">All Member PKS Muda</p>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-8">
                <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Member Sleman</p>
                    <h5 class="font-weight-bolder mb-0">
                    300
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-8">
                <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Member Kota</p>
                    <h5 class="font-weight-bolder mb-0">
                    500
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-8">
                <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Member Bantul</p>
                    <h5 class="font-weight-bolder mb-0">
                    200
    ...
    {{-- <div class="row mt-4">
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="bg-gradient-primary border-radius-lg h-100">
                    <img src="{{ url ('back_office/assets/img/shapes/waves-white.svg')}}" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                    <img class="w-100 position-relative z-index-2 pt-4" src="{{ url ('back_office/assets/img/illustrations/rocket-white.png')}}">
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('back_office./assets/img/ivancik.jpg');">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-xd.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        ...
                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                            <img alt="Image placeholder" src="{{ url ('back_office/assets/img/team-1.jpg')}}">
                        </a>
                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                            <img alt="Image placeholder" src="{{ url ('back_office/assets/img/team-2.jpg')}}">
                        </a>
                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                            <img alt="Image placeholder" src="{{ url ('back_office/assets/img/team-3.jpg')}}">
                        </a>
                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                            <img alt="Image placeholder" src="{{ url ('back_office/assets/img/team-4.jpg')}}">
                        </a>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-atlassian.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-slack.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-spotify.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-jira.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ url ('back_office/assets/img/small-logos/logo-invision.svg')}}" class="avatar avatar-sm me-3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
...
<div class="fixed-plugin">
    ...
    <div class="card-body pt-sm-3 pt-0">
        ...
        <a class="btn btn-outline-dark w-100" href="{{route('auth.logout_officer')}}">Sign Out</a>
